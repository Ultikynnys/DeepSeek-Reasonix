export const en = {
  ...
  settings: {
    ...
    typesafeSection: "JAI / TypeSafe Jev",
    typesafeHint: "Validates your key with TypeSafe before enabling jev_evaluate. Models only receive the JAI tool after validation succeeds; missing, rejected, or unreachable credentials keep it unavailable. Jev is not a chat model.",
    ollamaSubscription:
