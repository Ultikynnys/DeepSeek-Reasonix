export const en = {
  ...
  composer: {
    ...
    modelZaiGroup: "Z.AI",
    modelOpencodeGroup: "OpenCode",
    modelOpencodeRefresh: "Refresh",
    modelOpencodeError: "Couldn't fetch OpenCode models: {error}",
    modelCustomGroup: "Custom",
    modelAntigravityGroup: "Google Antigravity",
    modelNoneEnabled: "No models enabled — enable them in Settings → Models to pick them here.",
  ...
  settings: {
    ...
    webSearchApiKey: {
      ...
      opencode: "OpenCode API key (OpenCode Zen)",
      typesafe: "JEV API key (TypeSafe)",
    },
    ...
    modelVisibilityHint:
      "All models are off by default — enable the ones you want; enabled models appear in every picker.",
    modelEnable: "Enable",
    modelDisable: "Disable",
    modelEnableAll: "Enable all",
    modelDisableAll: "Disable all",
    modelEnabled: "enabled",
    modelEnabledCount: "{count} of {total} enabled",
    ...
    mcpConfiguredMode: "playwright server configured: {mode}",
    ...
    outlookMailTitle: "Outlook Mail integration",
    outlookMailDesc:
      "Connect a personal Outlook or Hotmail account. Reasonix runs a local mail-only MCP server and completes Microsoft device-code authentication here.",
    outlookMailConfigure: "Configure Outlook Mail",
    outlookMailConnect: "Connect Microsoft account",
    outlookMailTest: "Test connection",
    outlookMailTesting: "Testing connection…",
    outlookMailRetry: "Retry connection",
    outlookMailCancel: "Cancel sign-in",
    outlookMailSignOut: "Sign out",
    outlookMailOpenMicrosoft: "Open Microsoft sign-in",
    outlookMailCodeLabel: "Enter this code on the Microsoft page",
    outlookMailConnected: "✓ Connected as {account}",
    outlookMailAccountUnknown: "Microsoft account",
    ...
    noCustomRules: "No custom rules configured.",
    ruleTypeShell: "Command pattern",
    ruleTypePath: "Outside path prefix",
    addRule: "Add rule",
    rulePatternPlaceholder: "Enter command pattern (e.g. git *, npm test) or path prefix",
  ...
  app: {
    toast: {
      ...
      duplicatedSession: "Duplicated session — opening new tab",
  ...
  cards: {
    ...
    shellBackgroundRunning: "Running in background",
  ...
  statusbar: {
    ...
    zaiOffPeakTitle:
      "Z.AI off-peak — half of the standard rate · Peak hours 14:00–18:00 SGT (06:00–10:00 UTC, weekdays), off-peak all other times · changes in {when}",
    zaiPeakTitle:
      "Z.AI peak — the standard rate (off-peak is 50% off) · Peak hours 14:00–18:00 SGT (06:00–10:00 UTC, weekdays) · changes in {when}",
    authOauth: "oauth",
    authKey: "key",
    authNone: "no key",
  ...
  contextPanel: {
    ...
    duplicateSessionLimit: "Duplicate session limit",
    duplicateSessionLimitDesc:
      "Token budget kept when duplicating a session: the newest part of the transcript is kept and the oldest is dropped.",
    duplicateSessionLimitResetTooltip: "Reset to default (50K)",
    duplicateSessionAutoProceed: "Auto proceed",
    duplicateSessionAutoProceedOn: "On",
    duplicateSessionAutoProceedOff: "Off",
    enableDuplicateSessionAutoProceed: "Enable auto proceed",
    disableDuplicateSessionAutoProceed: "Disable auto proceed",
    duplicateSessionAutoProceedOnDesc:
      "A duplicated session runs one turn automatically to continue where the previous one left off.",
    duplicateSessionAutoProceedOffDesc:
      "Off by default: a duplicated session is seeded with the truncated context and stops — you send the next message.",
    ...
    allow: "ALLOW",
    ask: "ASK",
    customRulesTitle: "Global approval rules",
    noCustomRules: "No custom approval rules added.",
    addRuleBtn: "Add Rule",
    ruleTypeShell: "Shell command pattern",
    ruleTypePath: "Outside path prefix",
    rulePatternPlaceholder: "e.g. git *, npm test, /opt/tools",
    deleteRuleTooltip: "Remove rule",
  ...
  thread: {
    ...
    emailConfirmationKind: "email confirmation",
    emailConfirmationMeta: "explicit approval required · cannot be auto-approved",
