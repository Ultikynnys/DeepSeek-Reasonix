export const en = {
  ...
  settings: {
    ...
    antigravityClientId: "OAuth client id",
    antigravityClientIdHint: "The public Gemini CLI OAuth client id.",
    antigravityClientSecret: "OAuth client secret",
    antigravityClientSecretHint: "The public Gemini CLI OAuth client secret.",
