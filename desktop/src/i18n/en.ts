export const en = {
  ...
  settings: {
    ...
    openaiSignInHint: "Log in with an OpenAI website account — the token is stored locally and refreshed automatically.",
  ...
  statusbar: {
    ...
    balance: "balance",
    codexQuota: "codex",
    codexQuotaTitle: "Codex weekly quota · {used} / {limit} {currency} used · click to refresh",
