export const en = {
  ...
  settings: {
    ...
    mcpBrowserDesc:
      "Drive your real, logged-in Chrome/Edge tabs — the only mode that works on sites where you're signed in. Install the extension once, then configure the server below.",
    mcpOpenWebStore: "Open Chrome Web Store",
    ...
    mcpTestRunning: "testing relay — approve in Edge if the dialog appears…",
    ...
    mcpUnpackedHint:
      "Fallback: chrome://extensions → enable Developer mode → Load unpacked → pick this folder. Prefer the Web Store install.",
