...
export const zhCN: typeof en = {
  ...
  about: {
    ...
    downloadingUnknown: "正在下载… {downloaded}",
    installing: "正在安装…",
  ...
  composer: {
    ...
    modelOllamaRefresh: "刷新",
    modelOllamaError: "无法获取 Ollama 模型 — {error}",
    modelOllamaHidden: "{count} 个已隐藏（订阅）",
  ...
  settings: {
    ...
    effortXhighDesc: "介于 high 与 max 之间（GPT-5.6 系列）",
    effortMaxDesc: "最深推理（DeepSeek、GPT-5.6 Sol）",
    editMode: "审批模式",
    ...
    openaiSignInTitle: "网站登录",
    openaiSignIn: "使用 OpenAI 登录",
    openaiSignInHint: "使用 OpenAI 网站账号登录 — 令牌保存在本地并自动刷新。",
    openaiWaiting: "等待浏览器登录…",
    openaiSignedIn: "已通过 OpenAI 登录",
    openaiAccount: "以 {account} 登录",
    openaiTokenSet: "OAuth 令牌已生效",
    openaiSignOut: "退出登录",
    openaiCancel: "取消",
    openaiFlowFailed: "OpenAI 登录失败 — 请在本面板重新登录",
    openaiApiKey: "OpenAI API 密钥",
    openaiApiKeyHint: "可选 — 环境变量 OPENAI_API_KEY 优先；推荐使用 OAuth。",
    mcpSection: "已配置",
    ...
    ollamaBaseUrlHint:
      "OpenAI 兼容端点。留空 = 本地守护进程 http://localhost:11434/v1；Ollama 云端请填写此项和下方 API 密钥。",
    ollamaBaseUrlPlaceholder: "http://localhost:11434/v1",
    ollamaModels: "可用模型",
    ollamaModelsHint: "从端点实时获取 — 点击即可使用。",
    ollamaModelsRefresh: "刷新",
    ollamaModelsError: "无法获取模型 — {error}",
    ollamaSubscription: "{count} 个模型需要 Ollama 订阅（方案：{plan}）。在 ollama.com 升级以解锁。",
    ollamaPlan: "Ollama 方案：{plan}",
    effortSection: "推理强度",
    ctxWindow: "上下文",
    maxOutput: "输出",
  ...
  effort: {
    ...
    xhighDesc: "介于 high 与 max 之间（GPT-5.6 系列）",
    maxDesc: "最深推理（DeepSeek、GPT-5.6 Sol）",
  },
  checkpoint: {
    title: "步骤已完成",
    progress: "{done} / {total}",
  ...
  statusbar: {
    ...
    balance: "余额",
    codexQuota: "Codex",
    codexQuotaTitle: "Codex 每周配额 · 剩余 {left}% · 重置于 {resets} · 套餐 {plan} · 点击刷新",
    codexFiveHourTitle: "5 小时窗口：剩余 {left}%",
    codexRefreshing: "…",
    ...
    peak: "高峰",
    offPeakTitle:
      "非高峰 — 价格为高峰时段的半价 · 高峰时段 01:00–04:00 与 06:00–10:00 UTC（工作日）· 周末全天非高峰 · {when} 后切换",
    peakTitle:
      "高峰 — 价格为非高峰时段的两倍 · 高峰时段 01:00–04:00 与 06:00–10:00 UTC（工作日）· 周末全天非高峰 · {when} 后切换",
    authOauth: "OAuth",
    authKey: "密钥",
    authNone: "未登录",
    apiOpenaiOauth: "OpenAI · {baseUrl} · 已登录 {account}",
    apiOpenaiKey: "OpenAI · {baseUrl} · 手动 API 密钥",
    apiOpenaiNone: "OpenAI · {baseUrl} · 未登录 — 请在设置中登录 OpenAI",
    apiOllama: "Ollama · {baseUrl}",
    oauthFailed: "OpenAI 登录失败：{message} — 请从设置重新登录",
    switchTheme: "切换主题",
    themeDark: "深色",
    themeLight: "浅色",
    themeStyleGraphite: "Graphite",
  ...
  contextPanel: {
    ...
    foldTick: "自动折叠于 {tokens}",
    forceTick: "强制摘要于 {tokens}",
    compactionAt: "压缩 \u00b7 折叠@{fold} \u00b7 强制@{force}",
    exportMemories: "导出记忆",
    importMemories: "导入记忆",
    saveLabel: "保存",
    loadLabel: "加载",
    deleteMemory: "删除此记忆",
    newMemory: "新建记忆",
    newNamePh: "名称（如 budget-cap）",
    newBodyPh: "内容 — 未来会话需要知道什么？",
    saveMemory: "保存",
    cancelMemory: "取消",
  },
  memoryExport: {
    title: "导出记忆",
    hint: "保存此 JSON — 在另一个项目点击“加载”即可导入这些规则。",
    copy: "复制 JSON",
    copied: "已复制",
    close: "关闭",
  },
