...
export const de: typeof en = {
  ...
  settings: {
    ...
    openaiSignInHint: "Mit einem OpenAI-Websitekonto anmelden — das Token wird lokal gespeichert und automatisch erneuert.",
    ...
    openaiApiKeyHint: "Optional — die Umgebungsvariable OPENAI_API_KEY hat Vorrang; OAuth wird bevorzugt.",
    qqSection: "QQ-Kanal",
  ...
  statusbar: {
    ...
    codexQuotaPctTitle: "Codex-Wochenkontingent · {left}% übrig · zum Aktualisieren klicken",
    codexRefreshing: "…",
