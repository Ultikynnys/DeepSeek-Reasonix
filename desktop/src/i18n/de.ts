...
export const de: typeof en = {
  ...
  about: {
    ...
    downloading: "Lade herunter… {pct}%",
    downloadingUnknown: "Lade herunter… {downloaded}",
    installing: "Installiere…",
    updateFailed: "Update fehlgeschlagen: {message}",
  ...
  composer: {
    ...
    modelOllamaRefresh: "Aktualisieren",
    modelOllamaError: "Ollama-Modelle konnten nicht geladen werden — {error}",
    modelOllamaHidden: "{count} ausgeblendet (Abonnement)",
  ...
  settings: {
    ...
    effortXhighDesc: "zwischen high und max (GPT-5.6-Familie)",
    effortMaxDesc: "tiefstes Reasoning (DeepSeek, GPT-5.6 Sol)",
    editMode: "Edit-Gate",
    editModeHint:
    ...
    openaiSignInTitle: "Website-Anmeldung",
    openaiSignIn: "Mit OpenAI anmelden",
    openaiSignInHint:
      "Mit einem OpenAI-Websitekonto anmelden — das Token wird lokal gespeichert und automatisch erneuert.",
    openaiWaiting: "Warte auf die Browser-Anmeldung…",
    openaiSignedIn: "Mit OpenAI angemeldet",
    openaiAccount: "Angemeldet als {account}",
    openaiTokenSet: "OAuth-Token aktiv",
    openaiSignOut: "Abmelden",
    openaiCancel: "Abbrechen",
    openaiApiKey: "OpenAI-API-Schlüssel",
    openaiApiKeyHint:
      "Optional — die Umgebungsvariable OPENAI_API_KEY hat Vorrang; OAuth wird bevorzugt.",
    ...
    ollamaBaseUrlHint:
      "OpenAI-kompatibler Endpunkt. Leer = lokaler Daemon http://localhost:11434/v1; für die Ollama-Cloud hier und den Schlüssel unten eintragen.",
    ollamaBaseUrlPlaceholder: "http://localhost:11434/v1",
    ollamaModels: "Verfügbare Modelle",
    ollamaModelsHint: "Live vom Endpunkt geladen — anklicken zum Verwenden.",
    ollamaModelsRefresh: "Aktualisieren",
    ollamaModelsError: "Modelle konnten nicht geladen werden — {error}",
    ollamaSubscription: "{count} Modelle benötigen ein Ollama-Abonnement (Plan: {plan}). Upgrade auf ollama.com, um sie freizuschalten.",
  ...
  effort: {
    ...
    xhighDesc: "zwischen high und max (GPT-5.6-Familie)",
    maxDesc: "tiefstes Reasoning (DeepSeek, GPT-5.6 Sol)",
  },
  checkpoint: {
    ...en.checkpoint,
  ...
  cards: {
    ...
    compactionRunningBody:
      "Ältere Turns werden zu einer Zusammenfassung gefaltet — Esc unterbricht dies nicht.",
  ...
  statusbar: {
    ...
    codexQuota: "Codex",
    codexQuotaTitle:
      "Codex-Wochenkontingent · {left}% übrig · Reset {resets} · Plan {plan} · zum Aktualisieren klicken",
    codexFiveHourTitle: "5-Stunden-Fenster: {left}% übrig",
    codexRefreshing: "…",
    ...
    apiOpenaiOauth: "OpenAI · {baseUrl} · angemeldet als {account}",
    apiOpenaiKey: "OpenAI · {baseUrl} · manueller API-Schlüssel",
    apiOpenaiNone: "OpenAI · {baseUrl} · nicht angemeldet — in den Einstellungen anmelden",
    apiOllama: "Ollama · {baseUrl}",
    oauthFailed: "OpenAI-Anmeldung fehlgeschlagen: {message} — bitte erneut anmelden",
  ...
  contextPanel: {
    ...
    foldTick: "Auto-Fold bei {tokens}",
    forceTick: "erzwungene Zusammenfassung bei {tokens}",
    compactionAt: "Kompaktierung \u00b7 Fold@{fold} \u00b7 Force@{force}",
    exportMemories: "Erinnerungen exportieren",
    importMemories: "Erinnerungen importieren",
    saveLabel: "Speichern",
    loadLabel: "Laden",
    deleteMemory: "diese Erinnerung löschen",
    newMemory: "Neue Erinnerung",
    newNamePh: "Name (z. B. budget-cap)",
    newBodyPh: "Inhalt — was sollen künftige Sitzungen wissen?",
    saveMemory: "Speichern",
    cancelMemory: "Abbrechen",
  },
  memoryExport: {
    title: "Erinnerungen exportieren",
    hint: "JSON speichern — der Laden-Button in einem anderen Projekt importiert es.",
    copy: "JSON kopieren",
    copied: "Kopiert",
    close: "Schließen",
  },
  ...
  thread: {
    ...
    autoApproveIn: "wird in {n}s automatisch genehmigt — erste Option gewinnt",
