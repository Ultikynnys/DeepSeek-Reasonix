export interface TranslationSchema {
  ...
  errors: {
    ...
    deepseekNotFound: string;
    deepseekRequest: string;
    deepseekContext: string;
    deepseekTimeout: string;
    deepseekRate: string;
    deepseekServer: string;
    openaiAuth: string;
    openaiCredits: string;
    openaiPermission: string;
    openaiNotFound: string;
    ...
    openaiServer: string;
    ollamaAuth: string;
    ollamaCredits: string;
    ollamaPermission: string;
    ...
    ollamaRate: string;
    ollamaServer: string;
    antigravityAuth: string;
    antigravityCredits: string;
    antigravityPermission: string;
    antigravityNotFound: string;
    antigravityRequest: string;
    antigravityContext: string;
    antigravityTimeout: string;
    antigravityRate: string;
    antigravityServer: string;
    zaiAuth: string;
    zaiCredits: string;
    zaiPermission: string;
    zaiNotFound: string;
    zaiRequest: string;
    zaiContext: string;
    zaiTimeout: string;
