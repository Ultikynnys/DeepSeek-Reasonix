...
export const zhCN: TranslationSchema = {
  ...
  ui: {
      ...
      sections: [
        {
          ...
          rows: [
            ...
            { key: "Ctrl+K", text: "强制停止正在运行的工具（shell 命令）— 对话继续" },
    ...
    effortHint: "推理强度 — low|medium|high|xhigh|max",
    ...
    effortHintShort: "推理强度 — low|medium|high|xhigh|max",
  ...
  handlers: {
    ...
    model: {
      ...
      effortUsage: "用法：/effort <{list}>   （high 为安全默认；max 是 DeepSeek/GPT-5.6 扩展）",
  ...
  modelPicker: {
    ...
    effortDesc: {
      ...
      xhigh: "介于 high 与 max 之间（GPT-5.6 系列）",
      max: "最深推理（DeepSeek、GPT-5.6 Sol）",
    },
