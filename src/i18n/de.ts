...
export const de: TranslationSchema = {
  ...
  ui: {
    ...
    effortHint: "Reasoning-Effort – niedrig|mittel|hoch|x-hoch|maximal",
    ...
    effortHintShort: "Reasoning-Effort – niedrig|mittel|hoch|x-hoch|maximal",
  ...
  handlers: {
    ...
    model: {
      ...
      effortUsage:
        "Verwendung: /effort <{list}>   (high ist der sichere Standard; max ist eine DeepSeek-/GPT-5.6-Erweiterung)",
  ...
  modelPicker: {
    ...
    effortDesc: {
      ...
      xhigh: "zwischen high und max (GPT-5.6-Familie)",
      max: "tiefstes Reasoning (DeepSeek, GPT-5.6 Sol)",
    },
