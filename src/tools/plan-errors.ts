...
export class PlanProposedError extends ToolControlFlowError {
  ...
  override toToolResult(): { error: string; plan: string; steps?: PlanStep[]; summary?: string } {
...
export class PlanRevisionProposedError extends ToolControlFlowError {
